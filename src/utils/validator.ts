...
const KNOWN_CONTROLS: Record<string, string[]> = {
    ...
    'text': ['Text', 'X', 'Y', 'Width', 'Height', 'Size', 'Color', 'Align', 'Font', 'FontWeight', 'Visible', 'BorderColor', 'BorderThickness', 'Fill', 'OnSelect', 'PaddingLeft', 'PaddingRight', 'PaddingTop', 'PaddingBottom', 'AutoHeight', 'Wrap', 'Live', 'VerticalAlign'],
